...
module.exports = {
  ...
  plugins: [
    new CopyPlugin({
      patterns: [
        { from: 'firefox/public/manifest.json', to: 'manifest.json' },
        { from: 'firefox/public/options.html', to: 'options.html' },
        { from: 'firefox/public/options.js', to: 'options.js' },
        { from: 'firefox/public/styles.css', to: 'styles.css' },
